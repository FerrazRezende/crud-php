 ...
 */
final class Version20240320203024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD comment_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C7440455F8697D13');
        $this->addSql('ALTER TABLE client DROP comment_id');
    }
}
